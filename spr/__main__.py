...
async def help_command(_, message: Message):
    ...
    kb = ikb(
        {
            "ʜᴇʟᴘ": "bot_commands",
            "ᴏᴡɴᴇʀ": "https://t.me/nomorefakeworld",
            "ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ": f"https://t.me/{BOT_USERNAME}?startgroup=new",
            "ꜱᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ": "https://t.me/chatroom_xd",
        }
    )
    mention = message.from_user.mention
    await message.reply_photo(
        "https://telegra.ph/file/2b71b750d6d2d10b56bf1.jpg",
        caption=f"ʜɪ {mention}, ɪ'ᴍ ᴀɴᴛɪʀᴀɪᴅ ʀᴏʙᴏᴛ,"
...
async def commands_callback(_, cq: CallbackQuery):
...
async def help_parser(name, keyboard=None):
    ...
    return (
        f"ʜɪ {name}, ɪ'ᴍ ᴀɴᴛɪʀᴀɪᴅ ʀᴏʙᴏᴛ,ɪ ᴄᴀɴ ᴘʀᴏᴛᴇᴄᴛ "
...
async def help_button(client, query: CallbackQuery):
    ...
    top_text = (
        f"ʜɪ {u}, ɪ'ᴍ ᴀɴᴛɪʀᴀɪᴅ ʀᴏʙᴏᴛ,ɪ ᴄᴀɴ ᴘʀᴏᴛᴇᴄᴛ "
        + "ʏᴏᴜʀ ɢʀᴏᴜᴘ ꜰʀᴏᴍ ꜱᴘᴀᴍ ᴀɴᴅ ɴꜱꜰᴡ ᴍᴇᴅɪᴀ ᴜꜱɪɴɢ "
        + "ᴍᴀᴄʜɪɴᴇ ʟᴇᴀʀɴɪɴɢ. ᴄʜᴏᴏꜱᴇ ᴀɴ ᴏᴘᴛɪᴏɴ ꜰʀᴏᴍ ʙᴇʟᴏᴡ."
    )
    if mod_match:
...
async def runs_func(_, message: Message):
    await message.reply("ᴡʜᴏ ᴀᴍ ɪ , ʜɴʏ?")
